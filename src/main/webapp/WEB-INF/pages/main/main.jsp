		...
		$(document).ready(function() {
			$("#userImageBtn").click(function(){
				top.layer.open({
				    ...
				    area: ["700px", "500px"],
				    title:"上传头像",
				    content: "${ctx}/sysmgr/user/imageEdit" ,
				  	//  btn: ['确定', '关闭'],
	...
	<div id="main" style="width: auto;">
		<div id="header" class="navbar navbar-fixed-top" >
			<div class="navbar-inner" style="height:45px;padding: 5px">
				<div class="brand text-center"><span id="productName">邹及第OA系统 SpringMVC+Spring+Mybatis+Maven+Activiti</span></div>
				<ul id="userControl" class="nav pull-right">

					<li id="userInfo" class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息">您好, ${userName}&nbsp;</a>
						<ul class="dropdown-menu">
							<li><a href="${ctx}/sysmgr/user/gotoUserInfo" target="mainFrame"><i class="icon-user"></i>&nbsp; 个人信息</a></li>
							<li><a id="userImageBtn" data-toggle="modal"><i class="icon-cog"></i>&nbsp; 更换头像</a></li>
							<li><a href="${ctx}/sysmgr/user/gotoChangePwd" target="mainFrame"><i class="icon-lock"></i>&nbsp;  修改密码</a></li>
						</ul>
					</li>
	    ...
	    <div class="container-fluid">
			<div id="content" class="row-fluid">
				<div id="left" style="width: 160px; height: 604px;">	
					<div class="accordion" id = "menu-all">
					    ...
					    <c:if test="${menu.parentId eq parentId && menu.isShow eq '1'}" >
					      <div class="accordion-group">
					        <div class="accordion-heading">
					          <a class="accordion-toggle" data-toggle="collapse" data-parent="#menu-all" data-href="#collapse-${menu.id}" href="#collapse-${menu.id}" title="${menu.remarks}">
					            ...
					            <ul class="nav nav-list">
					              <c:forEach items="${menuList}" var="menu2" >
					                <c:if test="${menu2.parentId eq menu.id && menu2.isShow eq '1'}">
					                  <li>
					                    <a data-href=".menu3-${menu2.id}" href="${ctx}${menu2.href}" target="${empty menu2.target ? 'mainFrame' : menu2.target}">
					                    ...
					                    <ul class="nav nav-list hide" style="margin:0;padding-right:0;">
					                      <c:forEach items="${menuList}" var="menu3">
					                        ...
					                        <li class="menu3-${menu3.id} hide">
					                          <a data-href=".menu3-${menu3.id}" href="${ctx}${menu3.href}" target="${empty menu3.target ? 'mainFrame' : menu3.target}">
					  ...
					  <a href="${ctx}/sysmgr/user/gotoLayim" target="mainFrame">layim</a>
					</div> 
				</div>
		    ...
		    <div id="footer" class="row-fluid">
				Copyright © 2018-2028 <a href="http://www.bagebeyond.cn/" target="_blank">邹及第OA管理系统</a> - Powered By zjd V1.0
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
