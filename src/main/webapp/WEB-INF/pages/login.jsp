...
<link rel="shortcut icon" href="${ctxJsAndcss}/images/oa.ico" />
...
<body style = "border-radius: 10px;background-size:100% 100% ;background-image:url('${ctxJsAndcss}/images/background.jpg') ;">
	...
	<div class="row" id="login" >
		...
		<div class="well col-md-12 center">
			...
			<form id="loginForm"  action="${ctx}/login" method="post">
				...
				<label class="input-label" for="validateCode">图片验证码</label>
				<sys:validateCode name="validateCode" inputCssStyle="margin-bottom:5px;width:55px;margin-right:5px;"/>
				remeberme
	...
	<script type="text/javascript">
	 $(document).ready(function() {
		...
		if(self.frameElement && self.frameElement.tagName == "IFRAME" || $('#left').length > 0 || $('.jbox').length > 0){
			//top.layer.alert("未登录或登录超时。请重新登录，谢谢！", {icon : 0 ,title: "警告"});
