	 ...
	 getleaveProcessList:function(){
		 var leaveState = $("#leaveState").val();
	 		loading('正在提交，请稍等...'); 		
				...
				data: {"leaveState":leaveState},//传递给服务器的参数					
	 	...
	 	delLeaveProcess:function(leaveId){
	 		top.layer.confirm('您确定要删除此请假单吗?', {icon: 3, title:'系统提示'}, function(index){
		 		  $.ajax({
						type:'post',//请求方式
...
<form id="leaveProcessSearchForm" class="breadcrumb form-search" action="#" method="post">  
    <div class="controls">
		<label>请假单状态</label>
		 <select id="leaveState" name="leaveState" class="input-medium">
