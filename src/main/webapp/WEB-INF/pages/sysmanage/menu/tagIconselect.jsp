    ...
    <script type="text/javascript">
	    $(document).ready(function(){
	    	...
	    	$("#icons li").each(function(){
	    		if($(this).find('i').attr('class').split(" ")[1] == $("#icon").val()){
	    			$(this).click();
	    		}
	    	});
...
<div id="icons">
			    ...
			    <!-- <h2 class="page-header">66个4.4版本新图标</h2>
			     <ul class="the-icons">
			    ...
			    <h2 class="page-header">Web应用图标</h2>
			     <ul class="the-icons">
			    ...
			    <h2 class="page-header">文件类型 图标</h2>
			      <ul class="the-icons">
			   ...
			   <ul class="the-icons">
			    ...
			    <h2 class="page-header">表单控制 图标</h2>
			       <ul class="the-icons">
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square"></i> check-square</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square-o"></i> check-square-o</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle"></i> circle</li>
			    ...
			    <h2 class="page-header">文本编辑 图标</h2>
			       <ul class="the-icons">
			    ...
			    <h2 class="page-header">视频播放器 图标</h2>
			       <ul class="the-icons">
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrows-alt"></i> arrows-alt</li>
